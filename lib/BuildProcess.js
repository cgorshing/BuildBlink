...
var BuildProcess = function(pollInterval, config) {
  ...
  this.colorStrength = config.colorStrength || 155;
};
...
BuildProcess.prototype = {
  ...
  _doFade: function(fadeDelay, r, g, b, callback){
    try{
      ...
      console.log('TODO FIXME During development/testing, an error was reported that fromRGB was not defined');
      console.log(fromRGB);
  ...
  _setPoliceFlash: function() {
    ...
    that._cycleColors({
      r: 0,
      g: 0,
      b: this.colorStrength
    }, {
      r: this.colorStrength,
      g: 0,
      b: 0
    });
    setTimeout(function() {
  ...
  _setGreen: function() {
    stopflashing = true;
    this._setColor(0, this.colorStrength, 0);
  },
  ...
  _setRed: function() {
    ...
    this._setColor(this.colorStrength, 0, 0);
  }
