...
Setup.prototype = {
  ...
  gatherConfig: function() {
    ...
    var serviceType = readlineSync.question('CI service (enter number): \r\n 1. Teamcity \r\n 2. Codeship \r\n -->');
    config.serviceType = serviceType;
    if(serviceType === 1) {
      var teamcityServer = readlineSync.question('What is your Teamcity Server? (ip/fqdn and port.  No http)\r\n --> ');
      id = readlineSync.question('What is the buildtype id? \r\n --> ');
      name = readlineSync.question('What is the friendly name of this build? \r\n --> ');
      ...
      var apiKey = readlineSync.question('What is the api key id? \r\n --> ');
      id = readlineSync.question('What is the projectId of this build? \r\n --> ');
      name = readlineSync.question('What is the friendly name of this build? \r\n --> ');
