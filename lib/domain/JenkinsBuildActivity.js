...
JenkinsBuildActivity.prototype = {
  ...
  _isFreshlyRed: function(){
    ...
    var isPrevBuildGreen = this.previousBuild.result == 'SUCCESS' ? true : false;
    var isLatestBuildRed = this.currentBuild.result == 'FAILURE' || this.currentBuild.result == 'ERROR' ? true : false;
