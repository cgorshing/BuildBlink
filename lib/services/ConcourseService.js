...
ConcourseService.prototype.getBuildActivity = function(buildConfig, callback) {
  this.gateway.getBuildsForProjectId(buildConfig.team, buildConfig.pipeline, buildConfig.job_name, function(err, buildActivity) {
    if (buildActivity) callback(null, new ConcourseBuildActivity(buildActivity));
